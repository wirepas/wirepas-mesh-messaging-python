...
from .proto import StatusEvent as StatusEvent_pb
...
class OptionalGatewayFeature(enum.Enum):
    """
    OptionalGatewayFeature: Enum for optional gateway features that are supported
    """

    UNKNOWN       = StatusEvent_pb.UNKNOWN
    OTAP_AS_CHUNK = StatusEvent_pb.OTAP_AS_CHUNK
    CDD_API       = StatusEvent_pb.CDD_API
...
class StatusEvent(Event):
    ...
    Attributes:
        ...
        gw_features (list): list of OptionalGatewayFeature objects for supported features
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.gw_features = gw_features if gw_features else []
    ...
    def from_payload(cls, payload):
        ...
        gw_features = []
        for gw_feature in event.gw_features:
            gw_features.append(OptionalGatewayFeature(gw_feature))
    ...
    def payload(self):
        ...
        for gw_feature in self.gw_features:
            status.gw_features.append(gw_feature.value)
