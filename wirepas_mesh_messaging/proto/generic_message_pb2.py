...
_GENERICMESSAGECOLLECTION = _descriptor.Descriptor(
  name='GenericMessageCollection',
  full_name='wirepas.proto.gateway_api.GenericMessageCollection',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='generic', full_name='wirepas.proto.gateway_api.GenericMessageCollection.generic', index=0,
...
_GENERICMESSAGECOLLECTION.fields_by_name['generic'].message_type = _GENERICMESSAGE
...
DESCRIPTOR.message_types_by_name['GenericMessageCollection'] = _GENERICMESSAGECOLLECTION
...
GenericMessageCollection = _reflection.GeneratedProtocolMessageType('GenericMessageCollection', (_message.Message,), dict(
  DESCRIPTOR = _GENERICMESSAGECOLLECTION,
  __module__ = 'generic_message_pb2'
  # @@protoc_insertion_point(class_scope:wirepas.proto.gateway_api.GenericMessageCollection)
  ))
_sym_db.RegisterMessage(GenericMessageCollection)
